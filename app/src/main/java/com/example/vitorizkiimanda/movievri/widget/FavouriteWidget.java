...
public class FavouriteWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.example.vitorizkiimanda.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.vitorizkiimanda.EXTRA_ITEM";
